...
# Target definition
set(CMAKE_SYSTEM_NAME MRE_MODIS)
set(CMAKE_SYSTEM_PROCESSOR ARM)

#---------------------------------------------------------------------------------------
# Set toolchain paths
#---------------------------------------------------------------------------------------
set(TOOLCHAIN i686-pe)
if(NOT DEFINED TOOLCHAIN_PREFIX)
    ...
    elseif(CMAKE_HOST_SYSTEM_NAME STREQUAL Windows)
        message(STATUS "Please specify the TOOLCHAIN_PREFIX !\n For example: -DTOOLCHAIN_PREFIX=\"C:/Program Files/i686-pe\" ")
    else()
        set(TOOLCHAIN_PREFIX "/usr")
...
#set(CMAKE_EXE_LINKER_FLAGS "-Wl,--gc-sections -mthumb -fpic -fpcc-struct-return -pie -Wl,-Map=${CMAKE_PROJECT_NAME}.map" CACHE INTERNAL "Linker options")
