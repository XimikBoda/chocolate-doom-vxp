function(add_pack_vsm TARGET_NAME)
    ...
    if(${CMAKE_SYSTEM_NAME} STREQUAL MRE_NATIVE)
        set(SUFFIX ".vsm")
    elseif(${CMAKE_SYSTEM_NAME} STREQUAL MRE_MODIS)
        set(SUFFIX ".dlm")
    else()
        message(FATAL_ERROR "Unsupported target system for VSM packing.")
    endif()

    set(NULL_C "null_${TARGET_NAME}.c")

    add_custom_command( # repack triger
        OUTPUT ${NULL_C} 
        COMMAND ${CMAKE_COMMAND} -E touch ${NULL_C} 
        DEPENDS ${ARG_MREEXEC} ${ARG_RESOURCES}
    )

    add_library(${TARGET_NAME} STATIC ${NULL_C} )
